...
description 'Handling overrides for all tier cars — refresh this resource via txAdmin to hot-reload handling'
version '1.0.0'
...
data_file 'HANDLING_FILE' 'buffaloh.meta'
data_file 'HANDLING_FILE' 'jester5.meta'
data_file 'HANDLING_FILE' 'sent6.meta'
data_file 'HANDLING_FILE' 'gbgresleystx.meta'
...
-- Police / Chase
data_file 'HANDLING_FILE' 'gbpolargento7f.meta'
data_file 'HANDLING_FILE' 'gbpolbisonhf.meta'
data_file 'HANDLING_FILE' 'gbpolsentinelgts.meta'
data_file 'HANDLING_FILE' 'gbpolsultanrsx.meta'
data_file 'HANDLING_FILE' 'gbpoldomgsx.meta'
data_file 'HANDLING_FILE' 'gbpolprospero.meta'
data_file 'HANDLING_FILE' 'gbpolstanier.meta'
data_file 'HANDLING_FILE' 'gbpolscoutgsx.meta'
data_file 'HANDLING_FILE' 'gbpolcomets2r.meta'
data_file 'HANDLING_FILE' 'gbpoltr3s.meta'
