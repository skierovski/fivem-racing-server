(() => {
    ...
    const WHEEL_COLORS = [
        ...
        { idx: 3, label: 'Metallic Dark Silver', hex: '#454b4f' },
        { idx: 4, label: 'Metallic Silver', hex: '#999da0' },
        { idx: 5, label: 'Metallic Blue Silver', hex: '#c2c4c6' },
        { idx: 12, label: 'Metallic Red', hex: '#c00e1a' },
        { idx: 27, label: 'Metallic Dark Red', hex: '#6b0000' },
        { idx: 28, label: 'Metallic Orange', hex: '#bd4800' },
        { idx: 36, label: 'Metallic Yellow', hex: '#daaf0f' },
        { idx: 38, label: 'Metallic Lime', hex: '#418c1e' },
        { idx: 44, label: 'Metallic Green', hex: '#0a4c28' },
        { idx: 53, label: 'Metallic Galaxy Blue', hex: '#091c5e' },
        { idx: 54, label: 'Metallic Dark Blue', hex: '#0c0d18' },
        { idx: 61, label: 'Metallic Blue', hex: '#0b3f9b' },
        { idx: 64, label: 'Metallic Bright Blue', hex: '#2354a1' },
        { idx: 70, label: 'Metallic Purple', hex: '#320642' },
        { idx: 88, label: 'Metallic Bronze', hex: '#4a341b' },
        { idx: 90, label: 'Metallic Gold', hex: '#c2a557' },
        { idx: 92, label: 'Metallic Champagne', hex: '#b0ab94' },
        { idx: 111, label: 'Matte Black', hex: '#151515' },
        { idx: 112, label: 'Matte Gray', hex: '#3b3b3b' },
        { idx: 118, label: 'Matte Red', hex: '#800000' },
        { idx: 120, label: 'Matte Orange', hex: '#b04500' },
        { idx: 123, label: 'Matte Green', hex: '#305030' },
        { idx: 125, label: 'Matte Blue', hex: '#1a3060' },
        { idx: 127, label: 'Matte Purple', hex: '#352050' },
        { idx: 131, label: 'Chrome', hex: '#e8e8e8' },
        { idx: 156, label: 'Pure White', hex: '#ffffff' },
    ];
